...
<script type="text/javascript">
  $(function () {
    ...
    $('#spv_setuju').click(function(){
        ...
        var nip = $("#nip_preview").val();
        $.ajax({
            data: {id: id, id_peralatan: id_peralatan, nip: nip, id_status_pekerjaan: 3, status: 0},
            url: "{{ route('laporan.store') }}",
            type: "POST",
            dataType: 'json',
            success: function (data) {
    ...
    $('#manager_setuju').click(function(){
        ...
        var nip = $("#nip_preview").val();
        $.ajax({
            data: {id: id, id_peralatan: id_peralatan, nip: nip, id_status_pekerjaan: 4, status: 0},
            url: "{{ route('laporan.store') }}",
            type: "POST",
            dataType: 'json',
            success: function (data) {
    ...
    $('#tolakBtn').click(function(){
        ...
        $.ajax({
            data: {id: id, id_peralatan: id_peralatan, nip: nip, id_status_pekerjaan: id_status_pekerjaan, alasan_ditolak: alasan, status: 1},
            url: "{{ route('laporan.store') }}",
            type: "POST",
            dataType: 'json',
            success: function (data) {
